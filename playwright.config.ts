...
export default defineConfig({
  ...
  expect: {
    timeout: 5_000, // Não vale a pena aumentar porque o teste pode ficar lento no tempo de execução, vale a pena usar o timeout explicito  
  },
  ...
  use: {
    ...
    baseURL: 'https://velo-dicomonteiro.vercel.app'
  },
